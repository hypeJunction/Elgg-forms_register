...
} elseif (!elgg_get_plugin_setting('autogen_name', 'forms_register', false)) {
...
if (!elgg_get_plugin_setting('autogen_password', 'forms_register', false)) {
	echo elgg_view_field([
		...
		'data-parsley-minstrength' => elgg_get_plugin_setting('min_password_strength', 'forms_register', 0),
	]);
