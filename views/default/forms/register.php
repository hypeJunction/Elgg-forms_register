...
if (elgg_get_plugin_setting('first_last_name', 'elgg_forms_register', false)) {
...
} else if (elgg_get_plugin_setting('autogen_name', 'elgg_forms_register', false)) {
...
if (elgg_get_plugin_setting('autogen_name', 'elgg_forms_register', false)) {
...
if (elgg_get_plugin_setting('autogen_password', 'elgg_forms_register', false)) {
	...
	echo elgg_view_input('password', [
		...
		'minlength' => elgg_get_config('min_password_length') ? : 6, 'data-parsley-minstrength' => elgg_get_plugin_setting('min_password_strength', 'elgg_forms_register', 0),
	]);
